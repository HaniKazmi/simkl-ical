...
import { reconcileReleases } from '../src/sources/movies.js';
...
test('a snapshot round-trips, including the movieReleases Map', async () => {
  await withTempDataDir(async () => {
    const movieReleases = new Map([[300, { simkl_id: 300, title: 'A Film', date: '2026-12-18' }]]);
    await saveSnapshot({
...
const release = (id) => ({ simkl_id: id, title: `Film ${id}`, date: '2026-12-18' });
